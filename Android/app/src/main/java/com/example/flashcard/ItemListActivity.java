...
public class ItemListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final List<FlashcardSetContent.FlashcardSet> mValues;
        private final boolean mTwoPane;
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FlashcardSetContent.FlashcardSet item = (FlashcardSetContent.FlashcardSet) view.getTag();
                if (mTwoPane) {
                    Bundle arguments = new Bundle();
                    arguments.putString(ItemDetailFragment.ARG_ITEM_ID, item.setId);
                    ...
                    intent.putExtra(ItemDetailFragment.ARG_ITEM_ID, item.setId);
        ...
        SimpleItemRecyclerViewAdapter(ItemListActivity parent,
                                      List<FlashcardSetContent.FlashcardSet> items,
                                      boolean twoPane) {
            mValues = items;
